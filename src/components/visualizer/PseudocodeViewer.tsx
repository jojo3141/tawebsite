...
import { 
    ...
    PSEUDOCODE_GREEDY_COLORING, PSEUDOCODE_SMALLEST_LAST_COLORING, PSEUDOCODE_FORD_FULKERSON, PSEUDOCODE_LONG_PATH, PSEUDOCODE_HAMILTON_PATH, PSEUDOCODE_MIN_EDGE_CUT, PSEUDOCODE_SMALLEST_ENCLOSING_DISK, PSEUDOCODE_JARVIS_WRAP, PSEUDOCODE_LOCAL_REPAIR, PSEUDOCODE_FINDING_DUPLICATES_HASH, PSEUDOCODE_BLOOM_FILTER, PSEUDOCODE_FINDING_DUPLICATES_FLOYD, PSEUDOCODE_METRIC_TSP, PSEUDOCODE_METRIC_TSP_15,
    AlgorithmType 
} from '@/types/graph';
import {
...
const ALGORITHM_RUNTIMES: Record<string, string> = {
    ...
    [AlgorithmType.FINDING_DUPLICATES_HASH]: "\\mathcal{O}(n \\log n + |\\text{duplicates}| + |\\text{collisions}|)",
    [AlgorithmType.BLOOM_FILTER]: "\\mathcal{O}(k\\cdot n)",
    [AlgorithmType.FINDING_DUPLICATES_FLOYD]: "\\mathcal{O}(n)",
    [AlgorithmType.METRIC_TSP]: "\\mathcal{O}(n^2)",
    [AlgorithmType.METRIC_TSP_15]: "\\mathcal{O}(n^3)",
...
const PseudocodeViewer: React.FC<PseudocodeViewerProps> = ({ activeLine, algorithm, isDirected = true, dpApproach = 'BOTTOM_UP' }) => {
  ...
  if (Object.values(AlgorithmType).includes(algorithm as AlgorithmType)) {
      ...
      else if (algorithm === AlgorithmType.METRIC_TSP) {
          lines = PSEUDOCODE_METRIC_TSP;
      }
      else if (algorithm === AlgorithmType.METRIC_TSP_15) {
          lines = PSEUDOCODE_METRIC_TSP_15;
      }
  }
  // Sorting Algorithms
