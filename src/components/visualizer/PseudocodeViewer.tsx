...
import { 
    ...
    PSEUDOCODE_GREEDY_COLORING, PSEUDOCODE_SMALLEST_LAST_COLORING, PSEUDOCODE_FORD_FULKERSON, PSEUDOCODE_LONG_PATH, PSEUDOCODE_HAMILTON_PATH, PSEUDOCODE_MIN_EDGE_CUT, PSEUDOCODE_SMALLEST_ENCLOSING_DISK, PSEUDOCODE_JARVIS_WRAP, PSEUDOCODE_LOCAL_REPAIR, PSEUDOCODE_FINDING_DUPLICATES_HASH, PSEUDOCODE_BLOOM_FILTER,
    AlgorithmType 
} from '@/types/graph';
import {
