...
export default function Lesson1Page() {
  const lesson = lessons.find(l => l.week === 1);
...
import { lessons } from "@/data/lessons"; // Make sure this path is correct
import { motion } from "framer-motion";
import Link from "next/link";
...
export default function LessonDetailPage() {
  ...
  // Ensure we compare string to string or number to number.
  // useParams returns strings.
  const lesson = lessons.find((l) => l.week.toString() === week);
